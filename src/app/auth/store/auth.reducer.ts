...
const authFeature = createFeature({
  ...
  reducer: createReducer(
    ...
    on(
      ...
      (state: AuthStateInterface, action: { backendErrors: BackendErrorInterface }) => ({
        ...state,
        isSubmitting: false,
    ...
    on(authActions.getCurrentUser, (state: AuthStateInterface) => ({
      ...state,
      isSubmitting: true,
      validationErrors: null,
      isLoggedIn: true,
    })),
    on(authActions.getCurrentUserSuccess, (state: AuthStateInterface, action) => ({
      ...state,
      isSubmitting: false,
      currentUser: action.currentUser,
      isLoggedIn: false,
    ...
    on(authActions.getCurrentUserFailure, (state: AuthStateInterface) => ({
      ...state,
      isSubmitting: false,
      validationErrors: null,
      isLoggedIn: false,
